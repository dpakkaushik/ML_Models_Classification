...
def main():
    ...
    store = st.number_input("store",min_value=1.0,max_value=1115.0,step=1e-6,format="%.5f")
    competition_open_since_month = st.number_input("competition_open_since_month",min_value=1.0,max_value=12.0,step=1e-6,format="%.5f")
    store_type_d = st.number_input("store_type_d",min_value=0.,max_value=1.0,step=1e-6,format="%.5f")
    day_cos = st.number_input("day_cos",min_value=-1.0,max_value=1.0,step=1e-6,format="%.5f")
