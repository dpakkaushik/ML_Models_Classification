...
def main():
    ...
    day_cos = st.number_input("day_cos",min_value=-0.1,max_value=1.0,step=1e-6,format="%.5f")
    ...
    promo2_since_year = st.number_input("promo2_since_year", min_value=2009., max_value=2015.0, step=1e-6, format="%.5f")
    competition_time_month = st.number_input("competition_time_month", min_value=-1.0, max_value=19.0, step=1e-6, format="%.5f")
    promo2_since_week = st.number_input("promo2_since_week", min_value=1., max_value=50.0, step=1e-6, format="%.5f")
    assortment = st.number_input("assortment", min_value=0., max_value=3.0, step=1e-6, format="%.5f")
